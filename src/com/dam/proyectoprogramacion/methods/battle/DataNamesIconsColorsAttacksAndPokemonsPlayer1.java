...
public class DataNamesIconsColorsAttacksAndPokemonsPlayer1 {
     ...
     */
    private static String nameAttack1;
    private static String pathIconAttack1;
    private static Color colorBackgroundAttack1;

    private static String nameAttack2;
    private static String pathIconAttack2;
    private static Color colorBackgroundAttack2;

    private static String nameAttack3;
    private static String pathIconAttack3;
    private static Color colorBackgroundAttack3;

    private static String nameAttack4;
    private static String pathIconAttack4;
    private static Color colorBackgroundAttack4;

    private static String pathIconPokemon1;
    private static String namePokemon1;

    private static String pathIconPokemon2;
    private static String namePokemon2;

    private static String pathIconPokemon3;
    private static String namePokemon3;

    private static String imagePokemonInBattlePlayer1;

    /**
     * getter y setter de los atributos de la clase
     * @return el atributo correspondiente
     */
    public static String getNameAttack1() {
        return nameAttack1;
    }
    ...
    public static String getImagePokemonInBattlePlayer1() {
        return imagePokemonInBattlePlayer1;
    }

    public static void setImagePokemonInBattlePlayer1(String imagePokemonInBattlePlayer1) {
        DataNamesIconsColorsAttacksAndPokemonsPlayer1.imagePokemonInBattlePlayer1 = imagePokemonInBattlePlayer1;
    }
