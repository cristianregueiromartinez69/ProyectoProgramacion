...
//---------------------------------xAtaque numero 2 ---------------------------//
    ...
    /**
     * metodo para saber la cantidad de ataque del pokemon en batalla del jugador 2
     * @param namePokemon el nombre del pokemon en batalla
     * @return el valor del ataque
     */
    public static int getAmountAttackPokemonInBattlePlayer2(String namePokemon){
