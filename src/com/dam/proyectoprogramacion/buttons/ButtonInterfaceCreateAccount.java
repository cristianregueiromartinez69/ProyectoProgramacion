...
public class ButtonInterfaceCreateAccount extends JPanel {
    ...
    public JButton getIcon1Player1Button() {
        return icon1Player1Button;
    }

    public JButton getIcon2Player1Button() {
        return icon2Player1Button;
    }

    public JButton getIcon3Player1Button() {
        return icon3Player1Button;
    }

    public JButton getIcon4Player1Button() {
        return icon4Player1Button;
    }

    public JButton getIcon5Player1Button() {
        return icon5Player1Button;
    }

    public JButton getIcon6Player1Button() {
        return icon6Player1Button;
    }

    public JButton getIcon7Player1Button() {
        return icon7Player1Button;
    }

    public JButton getIcon8Player1Button() {
        return icon8Player1Button;
    }

    public JButton getIcon9Player1Button() {
        return icon9Player1Button;
    }

    public JButton getIcon10Player1Button() {
        return icon10Player1Button;
    }

    public JButton getIcon1Player2Button() {
        return icon1Player2Button;
    }

    public JButton getIcon2Player2Button() {
        return icon2Player2Button;
    }

    public JButton getIcon3Player2Button() {
        return icon3Player2Button;
    }

    public JButton getIcon4Player2Button() {
        return icon4Player2Button;
    }

    public JButton getIcon5Player2Button() {
        return icon5Player2Button;
    }

    public JButton getIcon6Player2Button() {
        return icon6Player2Button;
    }

    public JButton getIcon7Player2Button() {
        return icon7Player2Button;
    }

    public JButton getIcon8Player2Button() {
        return icon8Player2Button;
    }

    public JButton getIcon9Player2Button() {
        return icon9Player2Button;
    }

    public JButton getIcon10Player2Button() {
        return icon10Player2Button;
    }

    public JButton getReadyPlayer1Button() {
        return readyPlayer1Button;
    }

    public JButton getReadyPlayer2Button() {
        return readyPlayer2Button;
    }
