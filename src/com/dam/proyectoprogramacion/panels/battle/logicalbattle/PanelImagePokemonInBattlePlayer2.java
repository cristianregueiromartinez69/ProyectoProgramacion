...
import java.awt.*;
/**
 * Clase con  imagen de fondo del pokemon del jugador 2 en batalla
 * @author cristian
 * @version v3.0
 */
public class PanelImagePokemonInBattlePlayer2 extends JPanel{
    /**
     ...
     */
    public PanelImagePokemonInBattlePlayer2(Image backgroundImage) {
