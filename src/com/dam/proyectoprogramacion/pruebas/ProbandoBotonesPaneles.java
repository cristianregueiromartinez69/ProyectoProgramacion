...
public class ProbandoBotonesPaneles extends JFrame {
    ...
    public ProbandoBotonesPaneles() {
        ...
        pokemonPlayer1 = toBufferedImage(new ImageIcon("imagenes/tinkatonSP.png").getImage());
        pokemonPlayer2 = toBufferedImage(new ImageIcon("imagenes/SnorlaxSP.png").getImage());
